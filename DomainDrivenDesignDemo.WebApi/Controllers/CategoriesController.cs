using DomainDrivenDesignDemo.Application.Features.Categories.CreateCategory;
using DomainDrivenDesignDemo.Application.Features.Categories.GetAllCategory;
using MediatR;
